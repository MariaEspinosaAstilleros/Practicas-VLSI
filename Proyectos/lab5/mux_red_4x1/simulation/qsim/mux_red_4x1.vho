...
ARCHITECTURE structure OF mux_red_4x1 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \mux3|O~1_combout\ : std_logic;
...
\mux3|O~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \mux3|O~0_combout\ = (\KEY_EX[0]~input_o\ & ((\DIP_SW[6]~input_o\) # ((\KEY_EX[1]~input_o\)))) # (!\KEY_EX[0]~input_o\ & (((\DIP_SW[5]~input_o\ & !\KEY_EX[1]~input_o\))))
...
\mux3|O~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \mux3|O~1_combout\ = (\mux3|O~0_combout\ & ((\DIP_SW[8]~input_o\) # ((!\KEY_EX[1]~input_o\)))) # (!\mux3|O~0_combout\ & (((\DIP_SW[7]~input_o\ & \KEY_EX[1]~input_o\))))
...
PORT MAP (
	...
	datab => \mux3|O~0_combout\,
	datac => \DIP_SW[7]~input_o\,
	datad => \KEY_EX[1]~input_o\,
	combout => \mux3|O~1_combout\);
